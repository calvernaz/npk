...
~/.terraform.versions/terraform_0.11.0 init
~/.terraform.versions/terraform_0.11.0 apply -auto-approve
~/.terraform.versions/terraform_0.11.0 apply -auto-approve	# Yes, userdata.sh is an unresolvable cyclical dependency. I am ashamed.
